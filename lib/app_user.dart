...
final _userRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) =>
          const SetupHouseholdScreen(isEditMode: false),
    ),
    GoRoute(
      path: '/household/:id/edit',
      builder: (context, state) {
        final id = state.pathParameters['id']!;
        return SetupHouseholdScreen(isEditMode: true, householdId: id);
      },
    ),
  ],
);
